    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
      ...
      <div>
        <div className="relative-parent flex flex-col justify-center items-center h-screen">
          ...
          <br></br>
          <p><b>How to Play:</b> You will glimpse 5 drawings, one by one. Each image will disappear after a brief moment. After each image vanishes, a question will emerge, probing your memory for details lost to time. No second chances—rely on your wits alone. Answer at least 4 questions correctly to survive.</p>
